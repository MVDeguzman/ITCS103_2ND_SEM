...
def show_graph():
    ...
    ax.set_title("BSIT Section")
    ax.set_ylabel("1st Year Students")
...
#graph frame
graph_frame = tk.LabelFrame(frame, text="Graph", font= ("times new roman", 15))
graph_frame.grid(row=0, column=0, sticky= NSEW, pady=5, padx=20)

#show the bar graph

graph= tk.Button(frame, text= "Show Graph", font= ("arial normal", 10), command= show_graph)
graph.grid(row=7, column=0, sticky= NSEW, pady=10, padx=20)
